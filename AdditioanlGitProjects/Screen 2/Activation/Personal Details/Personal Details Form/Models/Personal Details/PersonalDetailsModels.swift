...
struct PersonalDetailsModels : Codable {
	let customerBasicInfoList : String?
	let customerFamilyList : [CustomerFamilyList]?
	let objCustomer : ObjCustomer?
	let pdf : String?
	...
	let objCustomerBasicDetailsActivation : String?
	let returnValue : Int?
	...
	init(from decoder: Decoder) throws {
		...
		customerFamilyList = try values.decodeIfPresent([CustomerFamilyList].self, forKey: .customerFamilyList)
		objCustomer = try values.decodeIfPresent(ObjCustomer.self, forKey: .objCustomer)
		...
		objCustomerBasicDetailsActivation = try values.decodeIfPresent(String.self, forKey: .objCustomerBasicDetailsActivation)
