//
//  iOS_CL_Cus_ConfirmationPopopVC.swift
//  ClubLink_iOS
//
...
protocol ConfirmationPopopDelegate: AnyObject{
	func didSelectBackConfirm()
}


class iOS_CL_Cus_ConfirmationPopopVC: UIViewController {
	...
	@IBOutlet weak var noBtn: UIButtonDesignable!
	@IBOutlet weak var yesBtn: GradientButton!
...
extension iOS_CL_Cus_ConfirmationPopopVC{
